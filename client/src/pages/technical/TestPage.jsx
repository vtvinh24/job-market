      ...
      <div>
        <header>
          ...
          <p>
            ...
            ut dictum purus, eu dictum eros. Ut tellus urna, vestibulum nec
            risus pellentesque, molestie cursus tortor. In vel condimentum
            augue, sed auctor neque. Sed mattis est id dolor faucibus fermentum.
            Quisque ut egestas nunc. Curabitur magna nisl, volutpat in lorem
            sed, pellentesque porta sem. Aenean in porta lacus, sed sagittis ex.
            Praesent viverra justo vel justo pellentesque dapibus. Maecenas
            maximus, leo eu pretium faucibus, urna leo aliquam sem, vitae
            dapibus diam justo vel mi.
          </p>
          <p>
            Nunc sodales tempus mattis. Nam elementum feugiat risus, at
            sollicitudin nunc pretium vel. Duis libero quam, maximus vestibulum
            erat at, accumsan auctor mauris. Nunc auctor pellentesque nisl, at
            tincidunt ipsum suscipit sit amet. Curabitur tellus dui, consequat
            pulvinar turpis quis, porta eleifend erat. Donec sit amet feugiat
            orci, vitae commodo nunc. Sed non nisi quis dolor suscipit efficitur
            id finibus nisi. Phasellus nec lectus ut lorem congue vestibulum.
            Aliquam tristique massa vel sem placerat fermentum. Sed neque urna,
            tincidunt pharetra auctor sed, dapibus id turpis. Duis non libero
            metus. Interdum et malesuada fames ac ante ipsum primis in faucibus.
            Sed eget enim neque. Vivamus tincidunt mauris in sollicitudin
            gravida. Aliquam a tempus mauris, a facilisis nulla.
          </p>
        </header>
        <nav>
          <ul>
          ...
          <section id="embedded">
            ...
            <article id="embedded__images">
              ...
              <div>
                ...
                <h3>
                  <code>&lt;figure&gt;</code> element with{" "}
                  <code>&lt;img&gt;</code> and <code>&lt;figcaption&gt;</code>{" "}
                  elements
                </h3>
                <figure>
                  <img
